...
import { ApiRequestError, changePassword, deleteAllRecords, signOutUser } from "@/lib/api";
    ...
    <main>
      ...
      <section className="grid split dashboard-panels">
        ...
        <article className="card stack">
          ...
          <p>
            Esto eliminara permanentemente tus sesiones, sus series y tus medidas corporales. Esta accion no se puede deshacer.
          </p>
          ...
          {!confirmDelete ? (
            ...
            <div className="form-grid">
              <p className="feedback error">
                ¿Estas seguro? Esta accion eliminara todos tus registros de entrenamiento y medidas de forma permanente.
              </p>
              <div className="hero-actions">
                <button
